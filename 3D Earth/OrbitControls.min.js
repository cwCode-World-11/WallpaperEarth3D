...
(THREE.OrbitControls = function (e, t) {
  ...
  void 0 === t &&
    ...
    (this.update =
      ...
      function () {
        ...
        n.copy(e).sub(s.target),
          ...
          s.enableDamping
            ? ((d.theta += b.theta * s.dampingFactor),
              (d.phi += b.phi * s.dampingFactor))
            : ((d.theta += b.theta), (d.phi += b.phi));
        var t = s.minAzimuthAngle,
          l = s.maxAzimuthAngle;
        return (
          isFinite(t) &&
            isFinite(l) &&
            (t < -Math.PI ? (t += c) : t > Math.PI && (t -= c),
            l < -Math.PI ? (l += c) : l > Math.PI && (l -= c),
            (d.theta =
              t < l
                ? Math.max(t, Math.min(l, d.theta))
                : d.theta > (t + l) / 2
                ? Math.max(t, d.theta)
                : Math.min(l, d.theta))),
          (d.phi = Math.max(s.minPolarAngle, Math.min(s.maxPolarAngle, d.phi))),
          d.makeSafe(),
          (d.radius *= T),
          (d.radius = Math.max(
            s.minDistance,
          ...
          !0 === s.enableDamping
            ? s.target.addScaledVector(O, s.dampingFactor)
            : s.target.add(O),
          ...
          !0 === s.enableDamping
            ? ((b.theta *= 1 - s.dampingFactor),
              (b.phi *= 1 - s.dampingFactor),
              O.multiplyScalar(1 - s.dampingFactor))
            : (b.set(0, 0, 0), O.set(0, 0, 0)),
          (T = 1),
          !!(
            f ||
            i.distanceToSquared(s.object.position) > h ||
            8 * (1 - r.dot(s.object.quaternion)) > h
          ) &&
            (s.dispatchEvent(u),
    ...
    (this.dispose = function () {
      s.domElement.removeEventListener("contextmenu", ee, !1),
        s.domElement.removeEventListener("pointerdown", B, !1),
        s.domElement.removeEventListener("wheel", W, !1),
        s.domElement.removeEventListener("touchstart", Q, !1),
        s.domElement.removeEventListener("touchend", $, !1),
        s.domElement.removeEventListener("touchmove", J, !1),
        s.domElement.ownerDocument.removeEventListener("pointermove", G, !1),
        s.domElement.ownerDocument.removeEventListener("pointerup", K, !1),
        s.domElement.removeEventListener("keydown", q, !1);
    });
  var s = this,
    u = { type: "change" },
    l = { type: "start" },
  ...
  var C,
    D =
      ((C = new THREE.Vector3()),
      function (e, t) {
        C.setFromMatrixColumn(t, 0), C.multiplyScalar(-e), O.add(C);
      }),
    S = (function () {
      ...
      return function (t, n) {
        ...
        if (s.object.isPerspectiveCamera) {
          ...
          (i *= Math.tan(((s.object.fov / 2) * Math.PI) / 180)),
            D((2 * t * i) / o.clientHeight, s.object.matrix),
            S((2 * n * i) / o.clientHeight, s.object.matrix);
        } else
  ...
  function _(e) {
    ...
    H.subVectors(R, g).multiplyScalar(s.rotateSpeed);
    var o = s.domElement;
    M((2 * Math.PI * H.x) / o.clientHeight),
      j((2 * Math.PI * H.y) / o.clientHeight),
      g.copy(R);
  }
  function F(e) {
    ...
    P.subVectors(y, v).multiplyScalar(s.panSpeed), k(P.x, P.y), v.copy(y);
  }
  function Z(e) {
    var t = e.touches[0].pageX - e.touches[1].pageX,
      n = e.touches[0].pageY - e.touches[1].pageY,
      o = Math.sqrt(t * t + n * n);
    w.set(0, o), A.set(0, Math.pow(w.y / L.y, s.zoomSpeed)), Y(A.y), L.copy(w);
  }
  function B(e) {
    if (!1 !== s.enabled)
        ...
        case "pen":
          !(function (e) {
            ...
            p !== E.NONE &&
              ...
              s.domElement.ownerDocument.addEventListener("pointerup", K, !1),
              s.dispatchEvent(l));
          })(e);
      }
  }
              ...
              case E.ROTATE:
                ...
                !(function (e) {
                  R.set(e.clientX, e.clientY),
                    H.subVectors(R, g).multiplyScalar(s.rotateSpeed);
                  var t = s.domElement;
                  M((2 * Math.PI * H.x) / t.clientHeight),
              ...
              case E.PAN:
                ...
                !(function (e) {
                  y.set(e.clientX, e.clientY),
                    P.subVectors(y, v).multiplyScalar(s.panSpeed),
                    k(P.x, P.y),
                    v.copy(y),
                    s.update();
                })(e);
  ...
  function W(e) {
    !1 === s.enabled ||
      ...
      s.dispatchEvent(l),
      (function (e) {
        e.deltaY < 0 ? x(N()) : e.deltaY > 0 && Y(N()), s.update();
      })(e),
      s.dispatchEvent(m));
  }
  function q(e) {
        ...
        case 2:
          switch (s.touches.TWO) {
            ...
            case THREE.TOUCH.DOLLY_ROTATE:
              ...
              !(function (e) {
                s.enableZoom && X(e), s.enableRotate && I(e);
              })(e),
                (p = E.TOUCH_DOLLY_ROTATE);
              break;
            default:
              p = E.NONE;
          }
    ...
    if (!1 !== s.enabled)
      switch ((e.preventDefault(), e.stopPropagation(), p)) {
        ...
        case E.TOUCH_DOLLY_PAN:
          if (!1 === s.enableZoom && !1 === s.enablePan) return;
          !(function (e) {
            s.enableZoom && Z(e), s.enablePan && F(e);
          })(e),
            s.update();
          break;
        case E.TOUCH_DOLLY_ROTATE:
          if (!1 === s.enableZoom && !1 === s.enableRotate) return;
          !(function (e) {
            s.enableZoom && Z(e), s.enableRotate && _(e);
          })(e),
            s.update();
          break;
        default:
  ...
  function $(e) {
    !1 !== s.enabled && (s.dispatchEvent(m), (p = E.NONE));
  }
  function ee(e) {
    !1 !== s.enabled && e.preventDefault();
  }
  s.domElement.addEventListener("contextmenu", ee, !1),
    s.domElement.addEventListener("pointerdown", B, !1),
    s.domElement.addEventListener("wheel", W, !1),
    s.domElement.addEventListener("touchstart", Q, !1),
    s.domElement.addEventListener("touchend", $, !1),
    s.domElement.addEventListener("touchmove", J, !1),
    s.domElement.addEventListener("keydown", q, !1),
